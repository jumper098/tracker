...
const TIERS = [
  ...
  { level: 2, label: '🥈 FORTGESCHRITTEN', cls: 'tier-2', ids: ['comeback','night_owl','unzerstoerbar','bad_beat','daylight_robbery','tourney_itm1','potm_1'] },
  { level: 3, label: '🥇 EXPERTE', cls: 'tier-3', ids: ['big_winner','profit_king','rebuy_king','collector_80','iron_man','legend','hat_trick','tourney_winner','tourney_itm5','potm_3'] },
